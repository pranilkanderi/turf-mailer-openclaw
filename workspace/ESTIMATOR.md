...
Produce this internal measurement object:
...
Using `net_turfable_sqft` from Step 1 and the pricing table above:
...
line items (standard):
  turf_material   = net_turfable_sqft × 1.73
  base_prep       = net_turfable_sqft × 1.30
  infill          = net_turfable_sqft × 0.35
  labor           = net_turfable_sqft × 1.75

line items (premium):
  turf_material   = net_turfable_sqft × 3.17
  base_prep       = net_turfable_sqft × 1.30
  infill          = net_turfable_sqft × 0.35
  labor           = net_turfable_sqft × 1.75
```
