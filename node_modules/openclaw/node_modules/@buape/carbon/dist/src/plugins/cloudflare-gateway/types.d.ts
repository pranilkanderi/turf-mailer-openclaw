...
import type { ListenerEventRawData, ListenerEventType } from "../../types/listeners.js";
...
export type CloudflareGatewayDurableObjectConfig = Omit<Pick<ClientOptions, "baseUrl" | "deploySecret" | "token" | "clientId">, "deploySecret"> & {
    deploySecret: string;
    forwardPath: `/${string}`;
    secretHeader: string;
    gateway: {
