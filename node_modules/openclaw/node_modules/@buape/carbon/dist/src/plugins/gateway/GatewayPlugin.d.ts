...
import { type APIGatewayBotInfo, type GatewayPayload, type GatewayPluginOptions, type GatewayState, type GatewayWebSocketLike, type RequestGuildMembersData, type UpdatePresenceData, type UpdateVoiceStateData } from "./types.js";
...
export declare class GatewayPlugin extends Plugin {
    ...
    protected ws: GatewayWebSocketLike | null;
    ...
    private nextConnectionShouldResume;
    private silentSocketClosures;
    ...
    protected onSocketEvent(socket: GatewayWebSocketLike, event: "open" | "message" | "close" | "error", handler: (incoming: unknown) => void): void;
    protected getMessageText(incoming: unknown): string | null;
    private extractSocketPayload;
    private getCloseCode;
    private getSocketError;
    private closeSocketImmediately;
    /**
