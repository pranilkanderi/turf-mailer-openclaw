 ...
 * @abstract
 */
export declare abstract class BaseListener<TEvent extends ListenerEventType = ListenerEventType> {
    abstract readonly type: TEvent;
    abstract handle(data: ListenerEventData[TEvent] & ListenerEventAdditionalData, client: Client): Promise<void>;
    abstract parseRawData(data: ListenerEventRawData[TEvent] & ListenerEventAdditionalData, client: Client): ListenerEventData[TEvent];
}
