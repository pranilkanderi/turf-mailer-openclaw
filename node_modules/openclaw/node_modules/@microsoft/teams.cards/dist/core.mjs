...
class CollabStageInvokeDataValue {
  /**
...
class MessageBackSubmitActionData {
  /**
   * Defines an optional key for the object. Keys are seldom needed, but in some scenarios, specifying keys can help maintain visual state in the host application.
   */
  key;
...
class TaskFetchSubmitActionData {
  /**
   * Defines an optional key for the object. Keys are seldom needed, but in some scenarios, specifying keys can help maintain visual state in the host application.
   */
  key;
...
export { ActionSet, AdaptiveCard, AreaGridLayout, AuthCardButton, Authentication, BackgroundImage, Badge, BarChartDataValue, CalendarEventAttendee, CalendarEventProperties, CaptionSource, CardMetadata, Carousel, CarouselPage, Choice, ChoiceSetInput, CodeBlock, CollabStageInvokeDataValue, Column, ColumnDefinition, ColumnSet, ComEventMicrosoftGraphComponent, ComFileMicrosoftGraphComponent, ComResourceMicrosoftGraphComponent, ComUserMicrosoftGraphComponent, ComUsersMicrosoftGraphComponent, CompoundButton, Container, DateInput, DonutChart, DonutChartData, ExecuteAction, Fact, FactSet, FileProperties, FlowLayout, GaugeChart, GaugeChartLegend, GridArea, GroupedVerticalBarChart, GroupedVerticalBarChartData, HorizontalBarChart, HorizontalBarChartDataValue, HostCapabilities, Icon, IconInfo, IconRun, ImBackSubmitActionData, Image, ImageRun, ImageSet, InsertImageAction, InvokeSubmitActionData, LineChart, LineChartData, LineChartValue, Media, MediaSource, Mention, MentionedEntity, MessageBackSubmitActionData, NumberInput, OpenUrlAction, OpenUrlDialogAction, PersonaProperties, PersonaSetProperties, PieChart, PopoverAction, ProgressBar, ProgressRing, QueryData, Rating, RatingInput, RefreshDefinition, ResetInputsAction, ResourceProperties, ResourceVisualization, Resources, RichTextBlock, ShowCardAction, SigninSubmitActionData, StackLayout, StackedHorizontalBarChart, StackedHorizontalBarChartData, StackedHorizontalBarChartDataPoint, StringResource, SubmitAction, SubmitActionData, TabInfo, Table, TableCell, TableRow, TargetElement, TaskFetchSubmitActionData, TeamsCardProperties, TeamsImageProperties, TeamsSubmitActionFeedback, TeamsSubmitActionProperties, TextBlock, TextInput, TextRun, ThemedUrl, TimeInput, ToggleInput, ToggleVisibilityAction, TokenExchangeResource, VerticalBarChart, VerticalBarChartDataValue, isActionSet, isAdaptiveCard, isAreaGridLayout, isBadge, isCarousel, isCarouselPage, isChoiceSetInput, isCodeBlock, isCollabStageInvokeDataValue, isColumn, isColumnSet, isComEventMicrosoftGraphComponent, isComFileMicrosoftGraphComponent, isComResourceMicrosoftGraphComponent, isComUserMicrosoftGraphComponent, isComUsersMicrosoftGraphComponent, isCompoundButton, isContainer, isDateInput, isDonutChart, isExecuteAction, isFactSet, isFlowLayout, isGaugeChart, isGroupedVerticalBarChart, isHorizontalBarChart, isIcon, isIconRun, isImBackSubmitActionData, isImage, isImageRun, isImageSet, isInsertImageAction, isInvokeSubmitActionData, isLineChart, isMedia, isMention, isMessageBackSubmitActionData, isNumberInput, isOpenUrlAction, isOpenUrlDialogAction, isPieChart, isPopoverAction, isProgressBar, isProgressRing, isQueryData, isRating, isRatingInput, isResetInputsAction, isRichTextBlock, isShowCardAction, isSigninSubmitActionData, isStackLayout, isStackedHorizontalBarChart, isSubmitAction, isTable, isTableCell, isTableRow, isTaskFetchSubmitActionData, isTextBlock, isTextInput, isTextRun, isTimeInput, isToggleInput, isToggleVisibilityAction, isVerticalBarChart };
