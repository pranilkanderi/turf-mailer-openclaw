import { ApplicationCommandType, type EntryPointCommandHandlerType, type RESTPostAPIApplicationCommandsJSONBody } from "discord-api-types/v10";
import type { Client } from "../classes/Client.js";
import { ApplicationIntegrationType, type ArrayOrSingle, type BaseMessageInteractiveComponent, type CommandMiddleware, type ConditionalCommandOption, InteractionContextType, type Permission } from "../index.js";
/**
...
export declare abstract class BaseCommand {
     ...
     * @internal
     */
    serialize(): import("discord-api-types/v10").RESTPostAPIChatInputApplicationCommandsJSONBody | import("discord-api-types/v10").RESTPostAPIContextMenuApplicationCommandsJSONBody | import("discord-api-types/v10").RESTPostAPIPrimaryEntryPointApplicationCommandJSONBody;
    /**
