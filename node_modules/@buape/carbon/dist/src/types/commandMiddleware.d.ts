...
export type CommandMiddleware = {
     ...
     */
    before?(context: Readonly<CommandMiddlewareBeforeContext>): boolean | undefined | Promise<boolean | undefined>;
    /**
     * Runs after command execution completes
     */
    after?(context: Readonly<CommandMiddlewareAfterContext>): Promise<void> | undefined;
};
